package com.trip.project.crawling;
		...
		try {
			...
			while (true) {
				...
				for (int i = 1; i <= 15; i++) {
					WebElement category = driver
							.findElement(By.xpath("/html/body/div/div[2]/div/div[2]/div/div/div/div[2]/div[5]/ul/li["
									+ i + "]/dl/dt/a/span"));
					if (category.getText().equals("음식점")) {
						Thread.sleep(3000);
						...
						extractAndSaveImages(driver, title, img);
				...
				WebElement nextPageButton = driver.findElement(
						By.xpath("/html/body/div/div[2]/div/div[2]/div/div/div/div[2]/div[5]/div[2]/div/a[13]"));
...
//			System.out.println("JSON file saved: " + jsonFilePath);
	...
	private static JSONArray restaurantsArray = new JSONArray();

	private static void printRestaurantInfo(WebDriver driver) throws InterruptedException { // 맛집 목록 가져오기
		Thread.sleep(5000);
		...
		try {
			By titleLocator = By
					.xpath("/html/body/div/div[2]/div/div[2]/div[2]/div/div/div[2]/div[1]/div[1]/div[2]/div[1]/h3");
		...
		restaurantObject.put("placeInfo", (detailcontent != null ? detailcontent.getText() : ""));
		restaurantObject.put("placeTag1", (tag1 != null ? tag1.getText() : ""));
		restaurantObject.put("placeTag2", (tag2 != null ? tag2.getText() : ""));
		restaurantObject.put("placeTag3", (tag3 != null ? tag3.getText() : ""));
		restaurantObject.put("placeLon", (y != null ? y : ""));
		restaurantObject.put("placeLat", (x != null ? x : ""));

		restaurantsArray.put(restaurantObject);

	}

	private static void extractAndSaveImages(WebDriver driver, WebElement title, WebElement img)
